...
/**
 * There are a couple of other not very well-documented 
 * callbacks that I have discovered and one of these 
 * extends the user profile settings, such that a link 
 * appears on the user's profile page.  
 * It might come in handy one day, so here it is:
 */
